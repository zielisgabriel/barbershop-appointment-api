    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
            ...
            .authorizeHttpRequests(request -> request
                .requestMatchers("/error", "/customer/create", "/invalidSession")
                    .permitAll()
                .requestMatchers("/customer/list", "/customer/delete", "/customer/update", "/available_time/list", "/customer_haircut/create", "/customer_haircut/list", "/customer_haircut/delete", "/haircut/list")
                    .authenticated()
                .requestMatchers("/available_time", "/available_time/create", "/available_time/delete", "/haircut/create", "/haircut/delete", "/haircut/update", "/customer/list")
                    .hasRole("ADMIN"))
